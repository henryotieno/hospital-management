...
{
	$user_access=MJ_hmgt_get_access_right_for_management_user_page('bed');
	...
	{	
		...
		{
			if (isset ( $_REQUEST ['page'] ) && 'bed' == $user_access['page_link'] && ($_REQUEST['action']=='edit'))
			{
			...
			if (isset ( $_REQUEST ['page'] ) && 'bed' == $user_access['page_link'] && ($_REQUEST['action']=='delete'))
			{
			...
			if (isset ( $_REQUEST ['page'] ) && 'bed' == $user_access['page_link'] && ($_REQUEST['action']=='insert')) 
			{
										...
										if(!empty($bed_data))
										{
										 ...
										 ?>
											<tr>
												...
												{?>
												<a href="?page=hmgt_bedmanage&tab=addbed&action=edit&bed_id=<?php echo esc_attr($retrieved_data->bed_id);?>" class="btn btn-info"> <?php esc_html_e('Edit', 'hospital_mgt' ) ;?></a>
												<?php 
												} 
												?>
